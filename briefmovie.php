...
// Vous devez créer une application web : vos recommandations, en tant qu’expert cinéphile, des meilleurs films du monde.
// Elle permet aux internautes de consulter cette liste de films, et d’obtenir des informations détaillées sur ceux-ci.
...
//////// Filtres
//// Ce site n’est pas un site de recherche de films, mais nous pouvons tout de même laisser l’internaute manipuler le hasard.
...
// Cette note doit être stockée en base de données sur 100, L'action se produit en ajax, bien sûr. Lorsqu'un film a déjà été noté,
// cette note doit s'afficher à la place du bouton.
////////////////////////  Page des films notés
// Une nouvelle page doit permettre de voir les films notés par l'utilisateur.
// Les films doivent être présentés par ordre de date de la note, et un système de pagination doit donc nécessairement être mis en place.
